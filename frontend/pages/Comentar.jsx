...
return (
    ...
    <Stack spacing={3}>
        ...
        <Textarea size={'lg'} placeholder='Escriba su Comentario' name="description" onChange={handleChange}/>
        <Button variant='outline' onClick={Comentar} colorScheme={"linkedin"}>Subir</Button>
